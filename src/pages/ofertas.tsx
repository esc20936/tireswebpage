...
const ofertas: ofertasProps[] = [
  {
    ...
    whatsappMessage: "¡Hola! Quiero saber más sobre la oferta de neumaticos 145R12",
  ...
  },
  {
    ...
    whatsappMessage: "¡Hola! Quiero saber más sobre la oferta de neumaticos 205/60R16",
